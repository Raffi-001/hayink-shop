        ...
        <div class="flex items-center justify-between flex-1 ml-4 lg:justify-end">
            ...
            <div class="flex items-center -mr-4 sm:-mr-6 lg:mr-0">
                ...
                Keyboard shortcuts
                        ...
                        <a href="{{ route('filament.designer.resources.designer-products.index') }}" class="flex items-center p-3 text-sm text-gray-600 capitalize transition-colors duration-300 transform dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white">
                            <svg class="w-5 h-5 mx-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
