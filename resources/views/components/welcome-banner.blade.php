...
<section class="flex flex-col md:flex-row justify-center md:min-h-screen ">
    <div class="relative flex w-full">
        <img src="images/cover-1.jpg" alt="" class="absolute inset-0 h-full w-full object-cover object-center">
        <div class="relative flex w-full flex-col items-start justify-end bg-black bg-opacity-40 p-8 sm:p-12">
            <h2 class="text-lg font-medium text-white text-opacity-75">For Every Ocasion</h2>
            <p class="mt-1 text-2xl font-medium text-white">Discover our latest collection of must-have t-shirts</p>
            <a href="#" class="mt-4 rounded-md bg-white px-4 py-2.5 text-sm font-medium text-gray-900 hover:bg-gray-50">Shop now</a>
        </div>
    </div>
    <div class="relative flex w-full">
        <img src="images/cover-2.jpg" alt="" class="absolute inset-0 h-full w-full object-cover object-center">
        <div class="relative flex w-full flex-col items-start justify-end bg-black bg-opacity-40 p-8 sm:p-12">
